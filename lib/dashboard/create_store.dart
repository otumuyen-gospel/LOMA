    ...
    return  SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("New Store", style: TextStyle(color: Colors.blue,fontFamily: 'verdana'),),
                  ...
                  Container(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(padding:const EdgeInsets.all(10), child:Text("Create Store",style: TextStyle(color: Colors.blue, fontSize: responsiveText(context)/2,
                              letterSpacing: 3)),),
