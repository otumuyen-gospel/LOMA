        ...
        child: Card(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(padding: const EdgeInsets.all(8),child:Text(description,style: const TextStyle(fontFamily: "verdana")),),
              Row(
                ...
                children: [
                  ...
                  Text(price,style: const TextStyle(fontFamily: "verdana", color: Colors.grey)),
                  Text(location,style: const TextStyle(fontFamily: "verdana", color: Colors.deepOrange)),
                ],
              ),
            ],
          ),
